class CreateFitlogs < ActiveRecord::Migration[8.0]
  def change
    create_table :fitlogs do |t|
      ...
      t.decimal :body_fat, precision: 4, scale: 1, comment: '体脂肪率'  # 最大値 99.9 まで扱える設定例
      t.decimal :muscle, precision: 4, scale: 1, comment: '筋肉量'  # 最大値 999.9 まで扱える設定例
      t.decimal :bmr, precision: 4, scale: 1, comment: '基礎代謝量'  # 最大値 9999.9 まで扱える設定例
      t.decimal :body_age, precision: 4, scale: 1, comment: '体年齢'  # 最大値 99.9 まで扱える設定例
